...
export default function Properties() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Hero & Search */}
      <section className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-8 sm:py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6 text-center">
            Find Your Dream Home
          </h1>
          <p className="text-base sm:text-lg md:text-xl mb-6 sm:mb-8 text-center opacity-90">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-4">
            <Input
              ...
              className="flex-1 h-12 sm:h-14 text-base sm:text-lg bg-white text-gray-900"
            />
            <Select value={statusType} onValueChange={(value: any) => setStatusType(value)}>
              <SelectTrigger className="w-full sm:w-[180px] h-12 sm:h-14 bg-white text-gray-900">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
            ...
            <Button
              ...
              size="lg"
              variant="secondary"
              className="w-full sm:w-auto px-8 h-12 sm:h-auto"
              disabled={loading}
            >
      ...
      <section className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6">
          <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-6 gap-3 sm:gap-4">
